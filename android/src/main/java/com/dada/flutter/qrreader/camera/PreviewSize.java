...
public final class PreviewSize {
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof PreviewSize) {
            PreviewSize other = (PreviewSize) obj;
     ...
     */
    public static PreviewSize parseSize(String string) throws NumberFormatException {
        ...
        try {
            return new PreviewSize(Integer.parseInt(string.substring(0, sep_ix)),
